...
<body>
  ...
  <a class="navbar-brand" href="#">
   ...
   <a href="index.jsp"  style="background-color: #003b64;color: white;padding: 6px 15px;text-align: center;text-decoration: none;display: inline-block; margin-left: 700px">HOME</a>
</nav>
<div id="page">
...
#selected-seats li{float:left; width:72px; height:26px; line-height:26px; border:1px solid #d3d3d3; background:#f7f7f7; margin:6px; font-size:14px; font-weight:bold; text-align:center}
   ...
   <div class="demo">
		...
		<div class="booking-details">
			<p>Movie: <span id="movie_name"><%=movie_name %></span></p>
			<p>Date: <span id="date"><%=date %></span></p>
			<p>Time: <span id="time"><%=time %></span></p>
			<p>Theatre: <span id="theatre"><%=theatre %></span></p>
			<p>Seat: </p>
		...
		<!--	<button onclick="selectSeat()" class="btn btn-primary" style="padding:10px;" align="left">BUY</button> -->
...
function recalculateTotal(sc) {
	...
	return total;
			...
			<center><button onclick="selectSeat()" class="btn btn-primary" style="padding:10px;">BUY</button> </center>
</p>  	
