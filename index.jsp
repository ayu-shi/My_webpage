            ...
            <div id="defaultmenu" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
					...
					<ul class="mov_list">
						...
						<li>Student of the year 2</li>
					</ul>
                                    </div><!-- end col-4 -->
                                    <div class="col-sm-4 movie-dd">
                                  		<h3 class="title">Next Change</h3>
										<p>Accidental Prime Minister</p>
										<p>Badla</p>
										<p>Lukka Chuppi</p>
										<p>KGF</p>
										<p>Gully Boy</p>
		 ...
		 <div class="col-md-4 banner-right">
			...
			<div id="myTabContent" class="tab-content">
			  <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">				  
				    ...
				    Inox</option>
			        <option style="padding-left: 10px;" value="Wave Cinema">Wave Cinema</option>
			        <option style="padding-left: 10px;" value="Pheonix">Rambha Mutiplex</option>
			        <option style="padding-left: 10px;" value="Pheonix">DDX Cinemas</option>
			        <option style="padding-left: 10px;" value="Pheonix">PVR Aura</option>
			        </select>
